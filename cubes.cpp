...
int main() {
  ...
  GLfloat tringle_gradiend[] = {
    -0.9f, -0.9f, 0.3f, 1.0f, 1.0f, 0.0f,
    -0.5f, -0.1f, 0.3f, 0.0f, 1.0f, 1.0f,
    -0.1f, -0.9f, 0.3f, 1.0f, 0.0f, 1.0f,
  };

  GLfloat tringle_texture[] = {
     0.1f,  0.1f, 0.3f, 0.0f, 0.0f,
     0.5f,  0.9f, 0.3f, 0.5f, 1.0f,
     0.9f,  0.1f, 0.3f, 1.0f, 0.0f,
  };

  GLfloat rect_color[] = {
    0.1f, -0.9f, 0.3f, 0.2f, 0.4f, 0.8f,
    0.1f, -0.1f, 0.3f, 0.2f, 0.4f, 0.8f,
    0.9f, -0.1f, 0.3f, 0.2f, 0.4f, 0.8f,
    0.9f, -0.1f, 0.3f, 0.2f, 0.4f, 0.8f,
    0.9f, -0.9f, 0.3f, 0.2f, 0.4f, 0.8f,
    0.1f, -0.9f, 0.3f, 0.2f, 0.4f, 0.8f,
  };

  GLfloat rect_texture[] = {
    -0.9f, 0.1f, 0.3f, 0.0f, 0.0f,
    -0.9f, 0.9f, 0.3f, 0.0f, 1.0f,
    -0.1f, 0.9f, 0.3f, 1.0f, 1.0f,
  ...
  GLfloat cross[] = {
     0.0f,  1.0f, 0.3f, 1.0f, 1.0f, 1.0f,
     0.0f, -1.0f, 0.3f, 1.0f, 1.0f, 1.0f,
     1.0f,  0.0f, 0.3f, 1.0f, 1.0f, 1.0f,
    -1.0f,  0.0f, 0.3f, 1.0f, 1.0f, 1.0f,
  };
...
//  glm::translate();
  ...
  while (wnd.run()) {
    ...
    glBindVertexArray(vao[5]);
    int i = 1;
    for (const auto& tns : cube_trans) {
      mat4f model = {};
      identity(model);
      float angle = 12 * i++;
      rotate(model, radians(angle), vec3f(0.5f, 1.0f, 0.3f));
      texture_shader.use();
